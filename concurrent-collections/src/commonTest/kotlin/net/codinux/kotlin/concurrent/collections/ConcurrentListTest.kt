...
class ConcurrentListTest {
    ...
    @Test
    fun add() = runTest {
        val underTest = ConcurrentList<String>()
    ...
    private fun assertItems(underTest: ConcurrentList<String>, vararg expectedItems: String) {
    ...
    private fun assertIsEmpty(underTest: ConcurrentList<String>) {
